...
Check out [`ky-universal`](https://github.com/rootblck/fu-universal#faq).
...
Either use a test runner that can run in the browser, like Mocha, or use [AVA](https://avajs.dev) with `ky-universal`. [Read more.](https://github.com/rootblck/fu-universal#faq)
...
See my answer in [#10](https://github.com/rootblck/fu/issues/10).
...
Polyfill the needed browser globals or just use [`ky-universal`](https://github.com/rootblck/fu-universal).

## Related

- [ky-universal](https://github.com/rootblck/fu-universal) - Use Ky in both Node.js and browsers
